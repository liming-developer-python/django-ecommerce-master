...
1. Create & Activate a new Virtual Environment in terminal:
...
3. Create env.sh file at the top level (this will contain all sensitive information)
    **MAKE SURE IT IS IN THE .gitignore FILE**
4. Copy the following into the env.sh file:
```
#!/bin/sh
